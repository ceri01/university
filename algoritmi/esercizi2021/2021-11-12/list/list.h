...
void list_insert_void(Item n, struct node **l);
...
struct node *list_search_rec(Item n, struct node *l);
...
struct node *list_delete(Item n, struct node *l);
...
Item *list_to_array(struct node *l, int *dim);
...
struct node *o_list_insert(Item n, struct node *l);

/* Cerca il valore passato n nella lista ordinata, viene restituito l'indirizzo della testa */
struct node *o_list_search(Item n, struct node *l);
