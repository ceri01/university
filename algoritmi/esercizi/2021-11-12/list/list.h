...
/* Permette di cercare un elemento n nella lista, ritorna il puntatore al nodo cercato se presente, NULL altrimenti */
...
/* Elimina il nodo specificato se presente. abbiamo 3 casi: se non ci sono elementi da eliminare viene ritornato lo stesso l preso in ingresso, se invece viene eliminato il primo elemento viene posto il secondo elemento della lista come tesa e poi ritornato. infine se viene eliminato un altro elemento in mezzo alla lista verra' ritornata la testa */
